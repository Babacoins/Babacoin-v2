...
In order to support loading of multiple wallets in babacoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is babacoin.cpp.
...
Changes to babacoin.cpp
----------------------
babacoin.cpp is the entry point into babacoin-qt, and as such, will require some minor modifications to provide hooks for
