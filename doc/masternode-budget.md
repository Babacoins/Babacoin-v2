...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<babacoin_address\> \<monthly_payment_babacoin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ BABA, _12_ times over the course of a year totaling _24000_ BABA.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<babacoin_address\> \<monthly_payment_babacoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` BABA.
 ...
 * vote-many          - Vote on a Babacoin initiative
 * vote-alias         - Vote on a Babacoin initiative
 * vote               - Vote on a Babacoin initiative/budget
