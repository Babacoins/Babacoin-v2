...
* API: [https://github.com/babacoin/insight-api-babacoin#swifttx-transactions](https://github.com/babacoin/insight-api-babacoin#swifttx-transactions)
...
By default, the Babacoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Babacoin Core daemon:
