...
RESOURCES += src/qt/babacoin.qrc src/qt/babacoin_locale.qrc

TRANSLATIONS += src/qt/locale/babacoin_bg.ts \
                src/qt/locale/babacoin_de.ts \
                src/qt/locale/babacoin_en.ts \
                src/qt/locale/babacoin_es.ts \
                src/qt/locale/babacoin_fi.ts \
                src/qt/locale/babacoin_fr.ts \
                src/qt/locale/babacoin_it.ts \
                src/qt/locale/babacoin_ja.ts \
                src/qt/locale/babacoin_pl.ts \
                src/qt/locale/babacoin_pt.ts \
                src/qt/locale/babacoin_ru.ts \
                src/qt/locale/babacoin_sk.ts \
                src/qt/locale/babacoin_sv.ts \
                src/qt/locale/babacoin_vi.ts \
                src/qt/locale/babacoin_zh_CN.ts \
                src/qt/locale/babacoin_zh_TW.ts
