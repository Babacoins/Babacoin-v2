...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the babacoin unit tests or QA tests
...
The following applies to code changes to the Babacoin Core project, and is not to be
confused with overall Babacoin Network Protocol consensus changes.
