...
#   c) node1 mines 32 blocks, so now node 0 has 500000BABA, node 1 has 4250BABA, node2 has none.
#   d) node0 sends 601 BABA to node2, in two transactions (301 BABA, then 300 BABA).
