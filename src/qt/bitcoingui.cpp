                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Babacoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BABA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and babacoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Babacoin Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Babacoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BABA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_black"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BABA addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Babacoin Core help message to get a list with possible Babacoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Babacoin Core client") + " " + networkStyle->getTitleAddText();
