...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::BABA, nValue);
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", false)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (babacoin.conf).");
            QMessageBox::warning(this, "Babacoin Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; background-color: #C8E5E2; color:#05ff71;}\n a, span { font-family: monospace; }\n span.addr {color:#13BE5D; font-weight: bold;}\n table tr td {padding: 3px; border: none; background-color: #ffffff;}\n td.d0 {font-weight: bold; color:#05ff71;}\n h2, h3 { white-space:nowrap; color:#1B7884;}\n a { text-decoration:none; }\n a.nav {color:green;}\n";
    //QString CSS = "body {font-size:12px; color:#05ff71; bgcolor:#05ff71;}\n a, span { font-family: monospace; }\n span.addr {color:#05ff71; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #ffffff;}\n td.d0 {font-weight: bold; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#05ff71;}\n a { color:#88f6f6; text-decoration:none; }\n a.nav {color:green;}\n";
