...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Babacoin features */
        {"babacoin", "masternode", &masternode, true, true, false},
        {"babacoin", "listmasternodes", &listmasternodes, true, true, false},
        {"babacoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"babacoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"babacoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"babacoin", "masternodedebug", &masternodedebug, true, true, false},
        {"babacoin", "startmasternode", &startmasternode, true, true, false},
        {"babacoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"babacoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"babacoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"babacoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"babacoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"babacoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"babacoin", "mnbudget", &mnbudget, true, true, false},
        {"babacoin", "preparebudget", &preparebudget, true, true, false},
        {"babacoin", "submitbudget", &submitbudget, true, true, false},
        {"babacoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"babacoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"babacoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"babacoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"babacoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"babacoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"babacoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"babacoin", "checkbudgets", &checkbudgets, true, true, false},
        {"babacoin", "mnsync", &mnsync, true, true, false},
        {"babacoin", "spork", &spork, true, true, false},
        {"babacoin", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"babacoin", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"babacoin", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"babacoin", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"babacoin", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"babacoin", "mncommunityvote", &mncommunityvote, true, true, false},
#ifdef ENABLE_WALLET
