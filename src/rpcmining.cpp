...
UniValue getgenerate(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "It is set with the command line argument -gen (or babacoin.conf setting gen)\n"
...
// NOTE: Unlike wallet RPC (which use BABA values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
